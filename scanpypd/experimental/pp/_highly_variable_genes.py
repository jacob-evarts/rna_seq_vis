...
from scanpypd import logging as logg
from scanpypd._settings import settings, Verbosity
from scanpypd._utils import check_nonnegative_integers, view_to_actual
from scanpypd.get import _get_obs_rep
from scanpypd._compat import Literal
from scanpypd._utils import _doc_params
from scanpypd.preprocessing._utils import _get_mean_var
from scanpypd.preprocessing._distributed import materialize_as_ndarray
from scanpypd.preprocessing._simple import filter_genes
from scanpypd.experimental._docs import (
    doc_adata,
    doc_dist_params,
...
def _highly_variable_pearson_residuals(
    ...
    """\
    See `scanpypd.experimental.pp.highly_variable_genes`.
